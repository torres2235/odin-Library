...
theHobbit.addBookCard(theHobbit);
sevenHabits.addBookToLibrary(sevenHabits);
sevenHabits.addBookCard(sevenHabits);
nineteenEightFour.addBookToLibrary(nineteenEightFour);
nineteenEightFour.addBookCard(nineteenEightFour);
